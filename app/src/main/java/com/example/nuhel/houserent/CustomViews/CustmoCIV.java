package com.example.nuhel.houserent.CustomViews;
...
/**
 * Created by Nuhel on 11/1/2017.
 */

public class CustmoCIV extends android.support.v7.widget.AppCompatImageView {
    ...
    public CustmoCIV(final Context context) {
        this(context, null);
    }

    public CustmoCIV(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustmoCIV(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setBorderWidth(float borderWidth) {
        ...
        this.paintBorder.setStrokeWidth(borderWidth);
        requestLayout();
        invalidate();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float stroke = paintBorder.getStrokeWidth();
        float refactor = (stroke / 5);
        float maxRed = (canvasSize / 2) + refactor;

        canvas.drawCircle(canvas.getWidth() / 2, canvas.getHeight() / 2, (maxRed) - (stroke * 2) - shadowRadius, paint);
        canvas.drawCircle(canvas.getWidth() / 2, canvas.getHeight() / 2, (maxRed) - (stroke) - shadowRadius, paintBorder);
    }
