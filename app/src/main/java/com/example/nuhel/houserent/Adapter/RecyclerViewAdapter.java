...
import com.example.nuhel.houserent.View.MainActivity;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    private LinkedHashMap<String, HomeAddListDataModel> add_list, add_list_temp;
    ...
    public RecyclerViewAdapter(Context context, RecyclerView recyclerView) {
        ...
        this.add_list_temp = new LinkedHashMap<>();
        loadMoreData();
        ...
        ChildEventListener vl = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (add_list.get(key) == null) {
                    ...
                    add_list_temp.put(dataSnapshot.getKey(), model);

                    AdList.add_list = add_list;
    ...
    class CustomFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            LinkedHashMap<String, HomeAddListDataModel> add_listnew = new LinkedHashMap<>();
            if (charSequence != null) {
                charSequence = charSequence.toString().toUpperCase();

                for (int i = 0; i < add_list_temp.size(); i++) {
                    if (((HomeAddListDataModel) add_list_temp.values().toArray()[i]).getArea().toUpperCase().contains(charSequence)) {
                        add_listnew.put(add_list_temp.keySet().toArray()[i].toString(), ((HomeAddListDataModel) add_list_temp.values().toArray()[i]));
                    }
                }
                filterResults.count = add_listnew.size();
                filterResults.values = add_listnew;
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            add_list = (LinkedHashMap<String, HomeAddListDataModel>) filterResults.values;
            notifyDataSetChanged();
        }
    }
